"""
Django settings for morning_field_41601 project.
...
ROOT_URLCONF = 'morning_field_41601.urls'
...
WSGI_APPLICATION = 'morning_field_41601.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "morning_field_41601 API",
    "DESCRIPTION": "API documentation for morning_field_41601 App",
    "VERSION": "v1",
}
